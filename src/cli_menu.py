import curses
from analysis import analysis_range



class MenuDisplay:

    def __init__(self, menu, df):
    ...
    def mainloop(self, stdscr):
        ...
        while 1:
            ...
            if key == curses.KEY_UP and current_row > 0:
                ...
                xxx = lambda: None
                menu = {
                'Rango de análisis': analysis_range,
                'Tabla de metabolización': xxx,
                'Aceleración metabólica de la glucosa':xxx,
                'Glucosa Promedio':xxx,
                'Glucosa-Meta':xxx,
                'Tendencia':xxx,
                'Salir':xxx
                }

                action = menu[self.menu[current_row]]
                action(self.df)
                ...
                if current_row == len(self.menu) - 1:
                    if self.confirm("Esta seguro que desea salir del programa?"):
                        break
...
if __name__ == "__main__":
    menu = [
        'Rango de análisis',
        'Tabla de metabolización',
        'Aceleración metabólica de la glucosa',
        'Glucosa Promedio',
        'Glucosa-Meta',
        'Tendencia',
        'Salir']
